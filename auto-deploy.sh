...
# Запуск мониторинга после развертывания
echo "📊 Запуск мониторинга..."
ssh_exec "cd $SERVER_PROJECT_PATH && chmod +x monitor.sh && ./monitor.sh"

echo ""
echo "🎉 Автоматическое развертывание успешно завершено!"
echo "🌐 Приложение доступно на http://$SERVER_HOST:3000"
echo "📡 WebSocket сервер на ws://$SERVER_HOST:8080"
echo "📊 Мониторинг: ssh $SERVER_USER@$SERVER_HOST 'cd $SERVER_PROJECT_PATH && ./monitor.sh'"