...
export default function Home() {
  ...
  console.log(`[page.tsx] 🔍 ДИАГНОСТИКА ЭКРАНА ЗАГРУЗКИ:`, {
    'состояние.загружается': состояние.загружается,
    'состояние.текущий_пользователь': !!состояние.текущий_пользователь,
    'настройки_загружены': настройки_загружены,
    'телеграм_готов': телеграм_готов,
    'телеграм_пользователь': !!телеграм_пользователь,
    'условие_загрузки': состояние.загружается || !состояние.текущий_пользователь || !настройки_загружены
  });
  
  if (состояние.загружается || !состояние.текущий_пользователь || !настройки_загружены) {
    console.log(`[page.tsx] 🔄 ПОКАЗЫВАЕМ ЭКРАН ЗАГРУЗКИ`);
    return (
