...
export default function Home() {
  ...
  useEffect(() => {
    // Не запускаем таймер если пользователь уже есть
    if (состояние.текущий_пользователь) {
      console.log(`[page.tsx] ⏭️ Пропускаем аварийный таймер - пользователь уже создан`);
      return;
    }
  ...
  }, [состояние.текущий_пользователь]); // Зависит от текущего пользователя
